      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              "fixed top-16 left-0 right-0 bg-white/5 backdrop-blur-xl border-b border-gray-200/50 shadow-xl z-50", // Changed absolute to fixed and adjusted top value
...
export const NavbarButton = ({ href, as: Tag = "button", children, className, variant = "primary", ...props }) => {
  const variants = {
    primary: "bg-white text-black font-bold text-base hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200",
    secondary:
